...
public class CuentaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      id=v.findViewById(R.id.cuenta_id);
      usuario=v.findViewById(R.id.cuenta_usuario);
      String user=usuarioActual.getEmail();
      int pos=user.indexOf("@");

      cerrarSesion=v.findViewById(R.id.cuenta_cerrar);

      id.setText(usuarioActual.getUid());
      usuario.setText(user.substring(0,pos));
